...
# sys.path.append(os.path.join(os.getcwd(),os.pardir,os.pardir,os.pardir,'Pretrained_models'))
root = os.path.join(os.getcwd(),'../../../../Pretrained_models')
...
alexnet_path = os.path.join(root, 'alexnet-owt-4df8aa71.pth')
