...
class FCN8s_alex(nn.Module):
	def __init__(self, num_classes, pretrained=True, caffe=False):
		...
		self.features3 = nn.Sequential(*features[: 3])
		self.features4 = nn.Sequential(*features[3: 6])
		self.features5 = nn.Sequential(*features[6:])

		self.score_pool3 = nn.Conv2d(128, num_classes, kernel_size=1) # changed
		self.score_pool4 = nn.Conv2d(384 , num_classes, kernel_size=1) # changed
		# self.score_pool3.weight.data.zero_()
		# self.score_pool3.bias.data.zero_()
		# self.score_pool4.weight.data.zero_()
		# self.score_pool4.bias.data.zero_()

		fc6 = nn.Conv2d(512, 512, kernel_size=7) #changed
